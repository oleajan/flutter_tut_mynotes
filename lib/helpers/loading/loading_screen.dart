...
import 'package:flutter_tut_mynotes/helpers/loading/loading_screen_controller.dart';
...
class LoadingScreen {
  ...
  LoadingScreenController showOverlay({required BuildContext context, required String text}) {
    ...
    // gets the size of the space our overlay can't have on the screen
        ...
        child: Center(
          child: Container(
            constraints: BoxConstraints(
              // consumes 80% of the available width
